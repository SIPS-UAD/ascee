...
export default function TeamEdit({ team, admins }: TeamEditProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/teams/${team.id_team}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Team Member: ${team.name}`} />
                        ...
                        <CardContent>
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="rounded-lg border bg-muted/30 p-4">
                                    <h3 className="mb-2 font-medium">Team Member Information</h3>
                                    <div className="space-y-1 text-sm text-muted-foreground">
                                        <p>
                                            <strong>Member ID:</strong> #{team.id_team}
                                        </p>
                                        <p>
