...
interface EducationCareersEditProps {
...
export default function EducationCareersEdit({ educationCareer, admins }: EducationCareersEditProps) {
    const [imagePreview, setImagePreview] = useState<string | null>(
        educationCareer.image ? `/storage/${educationCareer.image}` : null
    );
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        admin_id: educationCareer.admin_id.toString(),
        _method: 'PUT',
    });
                    ...
                    <div className="lg:col-span-1">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update the image for this entry (optional)
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
