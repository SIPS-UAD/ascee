...
export default function ConferenceEdit({ conference, admins }: ConferenceEditProps) {
    const [imagePreview, setImagePreview] = useState<string | null>(
        conference.image ? `/storage/${conference.image}` : null
    );
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Conference: ${conference.title}`} />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Update conference information</p>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update the conference details</CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <div className="lg:col-span-1">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update the conference image (optional)
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
