      ...
      <main>
        <section className="m-auto max-w-7xl bg-white pt-20 pb-8 sm:pt-22 sm:pb-12 lg:pt-24 lg:pb-16">
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            {/* Fix JOURNALS header with proper padding */}
            <div className="flex items-center">
              <div className="h-8 w-1 bg-blue-500"></div>
              <h1 className="text-lg font-bold ml-3">JOURNALS</h1>
            </div>
            ...
            <div className="py-10 flex flex-col md:flex-row gap-5">
                  ...
                  {journals.map(journal => (
                    <div key={journal.id_journal} className="flex flex-col">
                      ...
                      <div className="mt-2 text-center">
                        <h3 className="font-bold text-sm line-clamp-2">{journal.title}</h3>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* Right side - Quotes - Hidden on mobile, visible on md screens and up */}
              <div className="hidden md:block w-full md:w-1/3 flex-shrink-0">
                <Quotes/>
              </div>
            </div>
          </div>
